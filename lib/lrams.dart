      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
            ...
            suffixIcon: GestureDetector(
              ...
              child: Icon(_isPasswordVisible?Icons.visibility_outlined : Icons.visibility_off,color: Colors.white70,),
            ),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(10.0),
              borderSide: BorderSide(color: Colors.yellow.shade400),
        ...
        GestureDetector(
          onTap: () {
            login(emailController.text.toString(),
                passwordController.text.toString(), context, rememberMe);
          },
          child: Container(
...
void login(String username, String password, BuildContext context,
  ...
  try {
    Response response = await post(
        Uri.parse('https://library.parliament.gov.bd:8080/api/auth/login'),
    ...
    if (response.statusCode == 200) {
      ...
      final snackBar = SnackBar(
        duration: Duration(milliseconds: 2500),
        content: Text(
          "Please Enter & Check your email & password!",
          textAlign: TextAlign.center,
          style: TextStyle(
            fontSize: 15,
            fontWeight: FontWeight.w700,
