...
class _loansHistoryState extends State<loansHistory> {
  ...
  Future apicall() async {
    ...
    response = await get(
        ...
        Uri.parse('https://library.parliament.gov.bd:8080/api/profile/summary/loans/history'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Loans History',style: TextStyle(fontFamily: 'Montserrat',fontWeight: FontWeight.w500),),
        centerTitle: true,
      ),
      body: Column(
        children: [
